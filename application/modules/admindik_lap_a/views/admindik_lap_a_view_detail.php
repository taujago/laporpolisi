...
<form id="form_penyidik" method="post" action="<?php echo site_url("$controller/simpan_penyidik"); ?>">

<div class="row">

<div class="col-md-2">
PENUGASAN PENYIDIK :  </div>
<div class="col-md-6">
<?php 
$arr_penyidik = $this->cm->arr_penyidik();
$arr_penyidik =  $this->cm->add_arr_head($arr_penyidik,"x","== PILIH PENYIDIK =="); 
echo form_dropdown("id_penyidik",$arr_penyidik,$id_penyidik,'class="form-control" id="id_penyidik"');
?>
</div>
<div class="col-md-4">

<a  class="btn btn-primary" href="javascript:simpan_penyidik()"><span class="glyphicon glyphicon-floppy-saved"></span></i> SIMPAN PENYIDIK </a>
 </div>


</div> 
<input type="hidden" name="lap_a_id" value="<?php echo $lap_a_id; ?>" />
