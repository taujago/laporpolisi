...
$(document).ready(function(){
    ...
    $("#form_saksi").submit(function(){  // formulir saksi handler 
...
<?php if($mode=="U") :  ?>
  ...
  $.ajax({
    ...
    $("#modal_saksi").modal('show');
       ...
       $("#form_saksi").prop('action','<?php echo site_url("$controller/saksi_update/$lap_a_id") ?>')
...
<form action="<?php echo site_url("$controller/$action/$lap_a_id") ?>" id="form_saksi" method="post">
      ...
      "id","provinsi",'provinsi');
        ...
        <br />
            ...
            <a id="batal" href="<?php echo site_url("$controller/detail/$lap_a_id") ?>" class="btn btn-md btn-danger">BATAL </a> 
             <input  type="submit" value="SIMPAN SAKSI" class="tombol btn btn-md btn-primary">
