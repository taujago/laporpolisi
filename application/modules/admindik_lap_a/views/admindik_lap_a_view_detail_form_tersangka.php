...
<?php if($mode=="U") :  ?>
  ...
  $.ajax({
    ...
    $("#modal_tersangka").modal('show');
       ...
       $("#form_tersangka").prop('action','<?php echo site_url("$controller/tersangka_update/$lap_a_id") ?>')
...
<form action="<?php echo site_url("$controller/$action/$lap_a_id") ?>" id="form_tersangka" method="post">
