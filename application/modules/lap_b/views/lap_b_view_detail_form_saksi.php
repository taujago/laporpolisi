...
<?php if($mode=="U") :  ?>
  ...
  $.ajax({
    ...
    $("#modal_saksi").modal('show');
       ...
       $("#form_saksi").prop('action','<?php echo site_url("$controller/saksi_update/$lap_b_id") ?>')
...
<form action="<?php echo site_url("$controller/$action/$lap_b_id") ?>" id="form_saksi" method="post">
