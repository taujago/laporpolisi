...
<?php if($mode=="U") :  ?>
  ...
  $.ajax({
    ...
    $("#modal_korban").modal('show');
       ...
       $("#form_korban").prop('action','<?php echo site_url("$controller/korban_update/$lap_b_id") ?>')
...
<form action="<?php echo site_url("$controller/$action/$lap_b_id") ?>" id="form_korban" method="post">
